      ...
      >
        <HStack color="gray.700">
          ...
          <VStack align="left" justify="center" pl="10px">
            ...
            <Stack pt="20px" direction="row" align="center" pr="40px" gap={5}>
              <Button>
                <CiPlay1 size="30px" />
...
export default DesktopFavourite;

DesktopFavourite.getLayout = (page: React.ReactElement) => {
